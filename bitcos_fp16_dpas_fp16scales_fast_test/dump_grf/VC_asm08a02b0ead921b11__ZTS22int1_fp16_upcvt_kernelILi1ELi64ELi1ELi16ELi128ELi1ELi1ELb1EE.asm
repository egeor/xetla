//.kernel _ZTS22int1_fp16_upcvt_kernelILi1ELi64ELi1ELi16ELi128ELi1ELi1ELb1EE
//.platform XE2
...
// _ZTS22int1_fp16_upcvt_kernelILi1ELi64ELi1ELi16ELi128ELi1ELi1ELb1EE_BB_0:
(W)     mov (16|M0)              r235.0<1>:ud  r0.0<1;1,0>:ud                                        //  ALU pipe: int; $1
        ...
        shl (1|M0)               r249.0<1>:d   r249.0<0;1,0>:d   6:w               {Compacted,I@5}   //  ALU pipe: int; $10
...
(W)     mul (1|M0)               acc0.0<1>:d   r2.4<0;1,0>:d     r2.0<0;1,0>:uw   {I@4}              //  ALU pipe: int; $6
        add (1|M0)               r254.4<1>:d   r249.0<0;1,0>:d   64:w               {Compacted,I@4}  //  ALU pipe: int; $11
        ...
        bfn.(s0|s1&s2) (1|M0)    r249.0<1>:ud  r249.0<0;0>:ud    r6.0<0;0>:ud      0x30:uw              {I@1} //  ALU pipe: int; $15
