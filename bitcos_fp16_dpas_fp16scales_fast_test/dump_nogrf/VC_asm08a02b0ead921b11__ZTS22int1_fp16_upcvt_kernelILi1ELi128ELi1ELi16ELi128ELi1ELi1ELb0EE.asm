...
(W)     mul (1|M0)               acc0.0<1>:d   r2.4<0;1,0>:d     r2.0<0;1,0>:uw   {I@2}              //  ALU pipe: int; $6
        ...
        shl (1|M0)               r119.0<1>:d   r119.0<0;1,0>:d   7:w               {Compacted}       //  ALU pipe: int; $10
        ...
        add (1|M0)               r126.1<1>:d   r119.0<0;1,0>:d   128:w               {Compacted}     //  ALU pipe: int; $11
        add (8|M0)               r8.8<1>:d     r8.0<1;1,0>:d     8:w               {I@3}             //  ALU pipe: int; $18
        bfn.(s0|s1&s2) (1|M0)    r119.0<1>:ud  r119.0<0;0>:ud    r6.0<0;0>:ud      0x70:uw              {I@3} //  ALU pipe: int; $14
