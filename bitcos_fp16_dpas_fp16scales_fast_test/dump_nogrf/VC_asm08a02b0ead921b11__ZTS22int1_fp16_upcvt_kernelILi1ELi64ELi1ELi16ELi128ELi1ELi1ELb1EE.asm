...
(W)     mul (1|M0)               acc0.0<1>:d   r2.4<0;1,0>:d     r2.0<0;1,0>:uw   {I@2}              //  ALU pipe: int; $6
        ...
        shl (1|M0)               r121.0<1>:d   r121.0<0;1,0>:d   6:w               {Compacted}       //  ALU pipe: int; $10
        ...
        add (1|M0)               r126.4<1>:d   r121.0<0;1,0>:d   64:w               {Compacted}      //  ALU pipe: int; $11
        add (8|M0)               r92.8<1>:d    r92.0<1;1,0>:d    8:w               {I@3}             //  ALU pipe: int; $18
        bfn.(s0|s1&s2) (1|M0)    r121.0<1>:ud  r121.0<0;0>:ud    r6.0<0;0>:ud      0x30:uw              {I@3} //  ALU pipe: int; $14
