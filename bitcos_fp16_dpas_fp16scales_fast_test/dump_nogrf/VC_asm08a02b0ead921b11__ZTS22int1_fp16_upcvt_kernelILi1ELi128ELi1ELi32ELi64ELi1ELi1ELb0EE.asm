//.kernel _ZTS22int1_fp16_upcvt_kernelILi1ELi128ELi1ELi32ELi64ELi1ELi1ELb0EE
//.platform XE2
...
// _ZTS22int1_fp16_upcvt_kernelILi1ELi128ELi1ELi32ELi64ELi1ELi1ELb0EE_BB_0:
...
(W)     mul (1|M0)               acc0.0<1>:d   r2.4<0;1,0>:d     r2.0<0;1,0>:uw   {I@2}              //  ALU pipe: int; $6
        ...
        shl (1|M0)               r111.0<1>:d   r111.0<0;1,0>:d   7:w               {Compacted,I@3}   //  ALU pipe: int; $10
        ...
        add (1|M0)               r5.15<1>:d    r111.0<0;1,0>:d   128:w               {I@2}           //  ALU pipe: int; $11
        add (16|M0)              r9.0<1>:d     r8.0<1;1,0>:d     16:w               {Compacted,F@1}  //  ALU pipe: int; $20
        bfn.(s0|s1&s2) (1|M0)    r111.0<1>:ud  r111.0<0;0>:ud    r6.0<0;0>:ud      0x60:uw              {I@3} //  ALU pipe: int; $15
