...
/// @brief Is the GEMM functor, specialized in int2_bf16 matB kslicing dispatch policy and Xe architecture.
///
...
class gemm_universal_t<dispatch_policy_int2_bf16_dpas_kslicing<group_swizzle_, num_global_kslicing_, num_local_kslicing_, use_external_scale_a_>, gemm_t_, epilogue_t_,
...
private:
    ...
    static_assert(gemm_t::compute_policy::is_int2_bf16_dpas_policy, "should match with 2bit bf16 gemm impl");
